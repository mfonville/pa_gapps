...
# bksync and calsync will be added to GApps Install List as needed during script execution
stock_gapps_list="
cameragoogle
keyboardgoogle
sheets
...
sykopath
";
# supporting 'eleven' above temporarily to give users time to switch to cmeleven (see also update-binary)
# _____________________________________________________________________________________________________________________
