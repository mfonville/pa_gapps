...
zip -U $gms0 -O GMSCore/0/priv-app/PrebuiltGmsCore/PrebuiltGmsCore.apk --exclude lib* 
zip -U $gms4 -O GMSCore/4/priv-app/PrebuiltGmsCore/PrebuiltGmsCore.apk --exclude lib* 
zip -U $gms6 -O GMSCore/6/priv-app/PrebuiltGmsCore/PrebuiltGmsCore.apk --exclude lib* 
zip -U $gms8 -O GMSCore/8/priv-app/PrebuiltGmsCore/PrebuiltGmsCore.apk --exclude lib* 
...
zip -U $pg0 -O PlayGames/0/app/PlayGames/PlayGames.apk --exclude lib* 
zip -U $pg4 -O PlayGames/4/app/PlayGames/PlayGames.apk --exclude lib* 
zip -U $pg6 -O PlayGames/6/app/PlayGames/PlayGames.apk --exclude lib* 
zip -U $pg8 -O PlayGames/8/app/PlayGames/PlayGames.apk --exclude lib* 
...
zip -U $books -O GApps/books/app/Books/Books.apk --exclude lib* 
...
zip -U $calendar -O GApps/calendargoogle/app/CalendarGooglePrebuilt/CalendarGooglePrebuilt.apk --exclude lib* 
...
zip -U $calendar -O GApps/calsync/app/GoogleCalendarSyncAdapter/GoogleCalendarSyncAdapter.apk --exclude lib* 
...
zip -U $camera -O GApps/cameragoogle/app/GoogleCamera/GoogleCamera.apk --exclude lib* 
...
zip -U $chrome -O GApps/chrome/app/Chrome/Chrome.apk --exclude lib* 
...
zip -U $cloudprint -O GApps/cloudprint/app/CloudPrint2/CloudPrint2.apk --exclude lib* 
...
zip -U $docs -O GApps/docs/app/EditorsDocs/EditorsDocs.apk --exclude lib* 
...
zip -U $drive -O GApps/drive/app/Drive/Drive.apk --exclude lib* 
...
zip -U $ears -O GApps/ears/app/GoogleEars/GoogleEars.apk --exclude lib* 
...
zip -U $earth -O GApps/earth/app/GoogleEarth/GoogleEarth.apk --exclude lib* 
...
zip -U $exchange -O GApps/exchangegoogle/app/PrebuiltExchange3Google/PrebuiltExchange3Google.apk --exclude lib* 
...
zip -U $gmail -O GApps/gmail/app/PrebuiltGmail/PrebuiltGmail.apk --exclude lib* 
...
zip -U $googlenow -O GApps/googlenow/app/GoogleHome/GoogleHome.apk --exclude lib* 

#GooglePlus
googleplus=`find SourceAPKs/ -iname '*com.google.android.apps.plus*' | sort -r | head -1`
rm GApps/googleplus/app/PlusOne/PlusOne.apk
zip -U $googleplus -O GApps/googleplus/app/PlusOne/PlusOne.apk --exclude lib* 
...
zip -U $googletts -O GApps/googletts/app/GoogleTTS/GoogleTTS.apk --exclude lib* 
...
zip -U $hangouts -O GApps/hangouts/priv-app/Hangouts/Hangouts.apk --exclude lib* 
...
zip -U $keep -O GApps/keep/app/PrebuiltKeep/PrebuiltKeep.apk --exclude lib* 
...
zip -U $keybd -O GApps/keyboardgoogle/app/LatinImeGoogle/LatinImeGoogle.apk --exclude lib* 
...
zip -U $maps -O GApps/maps/app/Maps/Maps.apk --exclude lib* 
...
zip -U $messenger -O GApps/messenger/app/PrebuiltBugle/PrebuiltBugle.apk --exclude lib* 
...
zip -U $movies -O GApps/movies/app/Videos/Videos.apk --exclude lib* 
...
zip -U $music -O GApps/music/app/Music2/Music2.apk --exclude lib* 
...
zip -U $newsstand -O GApps/newsstand/app/Newsstand/Newsstand.apk --exclude lib* 
...
zip -U $newswidget -O GApps/newswidget/app/PrebuiltNewsWeather/PrebuiltNewsWeather.apk --exclude lib* 
...
zip -U $search -O GApps/search/priv-app/Velvet/Velvet.apk --exclude lib* 
...
zip -U $sheets -O GApps/sheets/app/EditorsSheets/EditorsSheets.apk --exclude lib* 
...
zip -U $slides -O GApps/slides/app/EditorsSlides/EditorsSlides.apk --exclude lib* 
...
zip -U $street -O GApps/street/app/Street/Street.apk --exclude lib* 
...
zip -U $talkback -O /GApps/talkback/app/talkback/talkback.apk --exclude lib* 
...
zip -U $wallet -O GApps/wallet/priv-app/Wallet/Wallet.apk --exclude lib* 
...
zip -U $youtube -O GApps/youtube/app/YouTube/YouTube.apk --exclude lib* 
